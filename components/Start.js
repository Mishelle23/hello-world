...
//Importing default background image
...
export default class Start extends React.Component {
  ...
  render() {
    return (
      // collection of components to create title and colors of the app
      <View style={styles.container}>
        <ImageBackground source={BackgroundImage} resizeMode="cover" style={styles.backgroundImage}>
          ...
          <View style={styles.box1}>
            ...
            {/*colors to choose from to change background.*/}
            ...
            {/*Way for the user to move to chat page via Button*/}
            <Pressable
              style={styles.button}
